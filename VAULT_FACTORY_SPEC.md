...
- **admin:**  
  The supervisory governance address for the deployment. It receives `DEFAULT_ADMIN_ROLE`, `PROPOSER_ROLE`, `EXECUTOR_ROLE`, and `CANCELLER_ROLE` on the deployment timelock.
