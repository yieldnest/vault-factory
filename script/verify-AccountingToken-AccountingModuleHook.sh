...
ACCOUNTING_TOKEN_CONTRACT="lib/yieldnest-flex-strategy/src/AccountingToken.sol:AccountingToken"
ACCOUNTING_MODULE_HOOK_CONTRACT="lib/yieldnest-flex-strategy/src/hooks/AccountingModuleHook.sol:AccountingModuleHook"
